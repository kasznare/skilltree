...
export const domainGuides: Record<DomainId, DomainGuide> = {
  movement: {
    ...
    growthArc: {
      ...
      preteen: 'Adapt to growth spurts, coordination changes, posture, and practice habits.',
      'early-adolescence': 'Train technique, recovery, body confidence, and pressure-safe competition.',
      'middle-adolescence': 'Build strength, endurance, mobility, and injury prevention with coaching.',
      'late-adolescence': 'Own lifelong fitness, recovery, physical standards, and healthy challenge.',
    },
  ...
  care: {
    ...
    growthArc: {
      ...
      preteen: 'Handle early puberty, grooming, sleep shifts, and private health questions.',
      'early-adolescence': 'Practice emotional recovery, nutrition, hygiene, and health privacy.',
      'middle-adolescence': 'Manage appointments, stress, sleep debt, training, and risk conversations.',
      'late-adolescence': 'Prepare to own health systems, insurance basics, medication, and preventive care.',
    },
  ...
  language: {
    ...
    growthArc: {
      ...
      preteen: 'Use reading, writing, search, and discussion for longer school and personal projects.',
      'early-adolescence': 'Argue with evidence, listen under emotion, and protect digital voice.',
      'middle-adolescence': 'Write, present, interview, and research for real audiences.',
      'late-adolescence': 'Communicate like an adult across work, school, civic, and intimate settings.',
    },
  ...
  reasoning: {
    ...
    growthArc: {
      ...
      preteen: 'Handle multi-step schoolwork, money choices, digital information, and schedules.',
      'early-adolescence': 'Think abstractly about systems, incentives, evidence, and consequences.',
      'middle-adolescence': 'Use planning, data, budgets, and risk analysis in real decisions.',
      'late-adolescence': 'Plan adult transitions, compare paths, and reason through long-term tradeoffs.',
    },
  ...
  social: {
    ...
    growthArc: {
      ...
      preteen: 'Navigate puberty, stronger peer comparison, belonging, and digital reputation.',
      'early-adolescence': 'Hold friendships, boundaries, repair, and identity under stronger emotion.',
      'middle-adolescence': 'Practice dating boundaries, team leadership, reputation, and social courage.',
      'late-adolescence': 'Build adult friendship, intimacy, collaboration, and community contribution.',
    },
  ...
  practical: {
    ...
    growthArc: {
      ...
      preteen: 'Own personal systems, simple meals, chores, local errands, and time planning.',
      'early-adolescence': 'Use tools, money, transit, calendars, and shared spaces with more independence.',
      'middle-adolescence': 'Build work habits, transport readiness, budgeting, and practical reliability.',
      'late-adolescence': 'Prepare for independent living, work, documents, money, and household standards.',
    },
  ...
  safety: {
    ...
    growthArc: {
      ...
      preteen: 'Handle phones, privacy, puberty boundaries, dares, and community movement.',
      'early-adolescence': 'Resist manipulation, unsafe secrecy, substance pressure, and digital traps.',
      'middle-adolescence': 'Prepare for driving contexts, dating safety, parties, work sites, and emergencies.',
      'late-adolescence': 'Own adult safety judgment, consent, health risk, crisis response, and legal stakes.',
    },
  ...
  creativity: {
    ...
    growthArc: {
      ...
      preteen: 'Use taste, fandoms, tools, and early portfolio habits to explore identity.',
      'early-adolescence': 'Turn emotion and identity into disciplined making and performance.',
      'middle-adolescence': 'Refine craft through feedback, audience, constraints, and sustained projects.',
      'late-adolescence': 'Build a mature creative practice, portfolio, taste, and contribution.',
    },
  ...
  character: {
    ...
    growthArc: {
      ...
      preteen: 'Hold honesty, patience, and self-respect during comparison and peer pressure.',
      'early-adolescence': 'Shape identity, courage, humility, service, and repair under emotional intensity.',
      'middle-adolescence': 'Practice accountability, work ethic, restraint, and principled risk-taking.',
      'late-adolescence': 'Prepare adult character: integrity, service, stewardship, dignity, and purpose.',
    },
...
export const stagePracticePrompts: Record<StageId, string[]> = {
  ...
  preteen: ['Make the skill concrete in puberty, peer, digital, and school contexts', 'Let him track progress and ask for help'],
  'early-adolescence': ['Pair independence with explicit boundaries and honest debriefs', 'Use real scenarios, not lectures alone'],
  'middle-adolescence': ['Give meaningful responsibility with visible standards', 'Connect practice to work, relationships, risk, and future options'],
  'late-adolescence': ['Move toward adult ownership with advisory support', 'Ask for plans, evidence, reflection, and repair'],
}
