...
const englishUi: UiCopy = {
  ...
  mapPanel: {
    world: 'World view shows an overview spine; filters redraw it as a focused skill slice.',
...
const hungarianUi: UiCopy = {
  ...
  mapPanel: {
    world: 'A világ nézet áttekintő gerincet mutat; a szűrők fókuszált készségszeletként rajzolják újra.',
